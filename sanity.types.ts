...
// Source: ./sanity/lib/orders/getMyOrder.tsx
...
// Variable: ACTIVE_SALE_BY_COUPONCODE_QUERY
// Query: *[        _type == "sale" && isActive == true && couponCode == $couponCode         ] | order(validFromm desc) [0]
export type ACTIVE_SALE_BY_COUPONCODE_QUERYResult = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
